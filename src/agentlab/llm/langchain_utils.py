...
class HuggingFaceAPIChatModel(HFBaseChatModel):
    def __init__(
        self,
        model_name: str,
        ...
        self.llm = HuggingFaceHub(
            repo_id=model_name,
            model_kwargs={"temperature": temperature, "max_length": max_new_tokens},
        )


class HuggingFaceLocalChatModel(HFBaseChatModel):
    def __init__(
        self,
        model_name: str,
        temperature: Optional[int] = 1e-1,
