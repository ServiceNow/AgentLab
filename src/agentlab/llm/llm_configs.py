...
CHAT_MODEL_ARGS_DICT = {
    ...
    "Qwen/Qwen2-7B-instruct": ChatModelArgs(
    ...
    "Qwen/Qwen2-1.5B": ChatModelArgs(
        model_name="Qwen/Qwen2-1.5B",
        training_total_tokens=32_768,
        model_size=1.5,
        is_model_operational=False,
        **default_oss_llms_args,
        info="weight lm_head.weight does not exist",
    ),
    "Qwen/Qwen2-0.5B": ChatModelArgs(
    ...
    "Qwen/Qwen2-57B-A14B-Instruct": ChatModelArgs(
    ...
    "bullerwins/Codestral-22B-v0.1-hf": ChatModelArgs(
    ...
    ## Bigcode
    "bigcode/starcoder2-15b-instruct-v0.1": ChatModelArgs(
    ...
    "bigcode/starcoder2-15b": ChatModelArgs(
