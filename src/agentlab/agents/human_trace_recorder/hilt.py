...
from agentlab.agents.human_trace_recorder.base_multi_candidate_agent import MultiCandidateAgent
...
def get_base_human_in_the_loop_genericagent(llm_config):
    ...
    from agentlab.agents.human_trace_recorder.hilt import HumanInTheLoopAgentArgs
    from agentlab.agents.human_trace_recorder.multi_candidate_generic_agent import (
...
if __name__ == "__main__":
    ...
    from agentlab.agents.human_trace_recorder.hilt import (
