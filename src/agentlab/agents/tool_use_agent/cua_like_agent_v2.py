...
CUA_LIKEV2_CLAUDE_4_SONNET = get_cua_like_agent_config("anthropic/claude-sonnet-4-20250514")
CUA_LIKEV2_CLAUDE_4_5_SONNET = get_cua_like_agent_config("anthropic/claude-sonnet-4-5-20250929")


if __name__ == "__main__":

    from agentlab.agents.tool_use_agent.cua_like_agent_v2 import CUA_LIKEV2_CLAUDE_4_SONNET
    ...
    # benchmark = benchmark.subset_from_list(["miniwob.ascending-numbers"])

    # uncomment to test on workarena_l1
